...
public class PinEntryFourEditText extends EditText {
    public static final String XML_NAMESPACE_ANDROID = "latspay";
    ...
    public PinEntryFourEditText(Context context) {
        super(context);
    }

    public PinEntryFourEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinEntryFourEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PinEntryFourEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
